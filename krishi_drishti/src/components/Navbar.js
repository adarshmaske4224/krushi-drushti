...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      <div className={`km-sidebar-backdrop ${isOpen ? 'open' : ''}`} onClick={onClose}></div>
      <div className={`km-sidebar ${isOpen ? 'open' : ''}`}>
    ...
    <nav className="km-navbar navbar">
      <div className="container-fluid px-4">
        <div className="d-flex align-items-center gap-3">
          <button className="km-hamburger" onClick={onToggleSidebar}>
